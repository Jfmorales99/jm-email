      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a2a3a">
          ...
          <div style="padding:32px">
            ...
            ${file_attached && file_attached !== 'None' ? `
            <p style="margin-top:16px;font-size:13px;color:#5a7fa8">📎 You also attached a file: <strong>${file_attached}</strong></p>
            ` : ''}
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a2a3a">
          ...
          <div style="padding:24px 32px">
            ...
            ${notes ? `
            <h3 style="font-size:13px;text-transform:uppercase;letter-spacing:1px;color:#1d5fad;border-bottom:1px solid #e0e8f0;padding-bottom:8px;margin-top:28px">Notes</h3>
